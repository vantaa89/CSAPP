...
0000000000400efc <phase_2>:
  ...
  400f0e:	74 20                	je     400f30 <phase_2+0x34>    goto 400f30
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax        a = *(b-4)
  400f1a:	01 c0                	add    %eax,%eax              a = a + a
  400f1c:	39 03                	cmp    %eax,(%rbx)            if (a == *b)
  400f1e:	74 05                	je     400f25 <phase_2+0x29>    goto 400f25
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx              b = b + 4
  400f29:	48 39 eb             	cmp    %rbp,%rbx              if(rbp != b)
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>    goto 400f17
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>  else return
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx         b = rsp+4
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp        bp = rsp-18
...
0000000000400f43 <phase_3>:
  400f43:	48 83 ec 18          	sub    $0x18,%rsp           rsp -= 24 // tmp[6]
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx       c = &tmp[3]
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx       d = &tmp[2]
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi       scanf("%d %d", rdi, &tmp[2], &tmp[3]);
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  400f60:	83 f8 01             	cmp    $0x1,%eax
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>  
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)       if(tmp[2] > 7)
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>    explode
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax       a = tmp[2]// fisrt input
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)   goto 0x402470 + 8 *rax
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax         if(a == second input)
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>
  400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>
  400fc9:	48 83 c4 18          	add    $0x18,%rsp
  400fcd:	c3                   	retq   

0000000000400fce <func4>:       // d = 14, esi = 0, edi = tmp[2]
...
000000000040100c <phase_4>:
  40100c:	48 83 ec 18          	sub    $0x18,%rsp                   allocate tmp[6]
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx               c = &tmp[3]
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx               d = &tmp[2]
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi               
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt> scanf("%d %d", &tmp[2], &tmp[3]);
  401029:	83 f8 02             	cmp    $0x2,%eax                    if (a != 2)
  40102c:	75 07                	jne    401035 <phase_4+0x29>          explode
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)               if(tmp[2] <= 14) i.e. first arg
  401033:	76 05                	jbe    40103a <phase_4+0x2e>          dont explode
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>        pass
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx                    d = 14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                    esi = 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi               edi = tmp[2]
  401048:	e8 81 ff ff ff       	callq  400fce <func4>               a = func4(tmp[2], 0, 14)
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c>        a should be 0
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)               if (tmp[3] != 0) explode
...
0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx       
  401063:	48 83 ec 20          	sub    $0x20,%rsp         allocate tmp[32]
  401067:	48 89 fb             	mov    %rdi,%rbx          b = rdi(input string)
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax      a = fs:0x28
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)    tmp[24] = a
  401078:	31 c0                	xor    %eax,%eax          a = 0
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>   length(input_str)
  40107f:	83 f8 06             	cmp    $0x6,%eax                if(length != 6)
  401082:	74 4e                	je     4010d2 <phase_5+0x70>      explode
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>    pass
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>    goto 4010d2: eax=0, next line
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx       c = input_str[a];
  40108f:	88 0c 24             	mov    %cl,(%rsp)               tmp[0] = c;
  401092:	48 8b 14 24          	mov    (%rsp),%rdx              d = tmp[0];
  401096:	83 e2 0f             	and    $0xf,%edx                remain d's only low 4 bit
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx      d = "maduiersnfotvbylSo you think you can stop the bomb with ctrl-c, do you?"[d]
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)    tmp[16+a] = d
  ...
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)          TMP[16] = 0
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi           esi = &"flyers"
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi          
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal> make tmp[16:] == flyers
...
00000000004010f4 <phase_6>:
  ...
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>    -> rsp부터 4바이트씩 입력 6개
  40110b:	49 89 e6             	mov    %rsp,%r14        r14 = &tmp[0]
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d       r12 = 0
  401114:	4c 89 ed             	mov    %r13,%rbp        rbp = r13 (=rsp)
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax   a = tmp[0]
  40111b:	83 e8 01             	sub    $0x1,%eax        a -= 1
  40111e:	83 f8 05             	cmp    $0x5,%eax        if ( a<= 5)
  401121:	76 05                	jbe    401128 <phase_6+0x34>  goto 401128
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>  else explode
  401128:	41 83 c4 01          	add    $0x1,%r12d       r12 += 1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d       if (r12 == 6)
  401130:	74 21                	je     401153 <phase_6+0x5f>  goto 401153
  401132:	44 89 e3             	mov    %r12d,%ebx       b = r12

  401135:	48 63 c3             	movslq %ebx,%rax        a = b
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax       a += tmp[a];
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)           if(a == tmp[0])
  40113e:	75 05                	jne    401145 <phase_6+0x51>      explode
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>    
  401145:	83 c3 01             	add    $0x1,%ebx            b = b + 1     
  401148:	83 fb 05             	cmp    $0x5,%ebx            if ( b <= 5) goto 401135


  40114b:	7e e8                	jle    401135 <phase_6+0x41>    
  40114d:	49 83 c5 04          	add    $0x4,%r13            r13 += 4// tmp의 인덱스 1 증가
  401151:	eb c1                	jmp    401114 <phase_6+0x20>  goto 401114
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi      rsi = &tmp[6]
  401158:	4c 89 f0             	mov    %r14,%rax            a = r14
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx            c = 7

  401160:	89 ca                	mov    %ecx,%edx            d = c (=7)
  401162:	2b 10                	sub    (%rax),%edx          d -= *a (= tmp[0])
  401164:	89 10                	mov    %edx,(%rax)          tmp[0] = d
  401166:	48 83 c0 04          	add    $0x4,%rax            ++a(iterator)
  40116a:	48 39 f0             	cmp    %rsi,%rax            if (a != &tmp[6])
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>  goto 401160
...
000000000040145c <read_six_numbers>:                  input: arr
  40145c:	48 83 ec 18          	sub    $0x18,%rsp       rsp -= 24: tmp[6]
  401460:	48 89 f2             	mov    %rsi,%rdx        d = arr
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx   c  = &arr[1]
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax  a = &arr[5]
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)   tmp[2] = a
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax  a = &arr[4]
  401474:	48 89 04 24          	mov    %rax,(%rsp)      tmp[0] = a
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9    r9 = &arr[3]
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8    r8 = &arr[2]
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi   rsi = &"%d %d %d %d %d"
  401485:	b8 00 00 00 00       	mov    $0x0,%eax        eax = 0
  40148a:	e8 61 f7 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  40148f:	83 f8 05             	cmp    $0x5,%eax        if(eax > 5) return
  401492:	7f 05                	jg     401499 <read_six_numbers+0x3d>
  401494:	e8 a1 ff ff ff       	callq  40143a <explode_bomb> else explode
